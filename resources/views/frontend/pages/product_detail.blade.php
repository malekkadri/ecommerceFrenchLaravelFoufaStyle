...
@endsection
@section('title','Foufa Style || DÉTAIL DU PRODUIT')
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="short">
                                                ...
                                                @endphp
                                                 @if (($product_detail->price-($product_detail->price*$product_detail->discount)) != $after_discount)
                                                ...
                                                @else
                                                <p class="price"><span>TND {{number_format($product_detail->price,2)}}</span> </p>
												<p class="description">{!!($product_detail->summary)!!}</p>
                                                @endif
											...
											@if($product_detail->color)
												<div class="size mt-4">
													...
													<ul>
														...
														<li><a href="#" class="one">{{$color}}</a></li>
														@endforeach
													</ul>
												</div>
											@endif
