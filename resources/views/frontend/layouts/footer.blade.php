				...
				<div class="row">
					<div class="col-lg-5 col-md-6 col-12">
						...
						<div class="single-footer about">
							...
							<p class="call">
                                Vous avez une question ? Appelez-nous 24h/24 et 7j/7<span><a href="tel:123456789">@foreach($settings as $data) {{$data->phone}} @endforeach</a></span></p>
						</div>
						<!-- End Single Widget -->
					</div>
					<div class="col-lg-2 col-md-6 col-12">
						...
						<div class="single-footer links">
							<h4>Informations</h4>
							<ul>
								<li><a href="{{route('about-us')}}">Qui sommes-nous ?</a></li>
								<li><a href="#">FAQ</a></li>
